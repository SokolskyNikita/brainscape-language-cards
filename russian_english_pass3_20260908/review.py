...
BASE=ROOT/'russian_english_pass3_20260908'
def patch(deck, changes):
 p=ROOT/'russian_english'/f'deck_{deck}.csv'; cards=cards_from_path(p); log=[]
...
def dump(deck):
 for i,c in enumerate(cards_from_path(ROOT/'russian_english'/f'deck_{deck}.csv'),1):

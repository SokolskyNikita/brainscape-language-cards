...
r=json.loads((B/'result.json').read_text());v=json.loads((B/'qa_live/repair_validation.json').read_text())
assert r['status']=='complete' and v['vocabulary_flags']==0
text='''# English example repairs — 22 September 2026
